...
export default function Nav() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed sm:sticky top-0 left-0 h-screen z-50 sm:z-30 bg-white border-r border-slate-200 flex flex-col items-center py-3 gap-1 overflow-y-auto transition-transform duration-200 w-20 ${
