...
const GROUPS: {
  ...
  { group: "sale", labelKey: "nav_groupSale", Icon: ShoppingCart, tint: "bg-blue-50 text-blue-600" },
  { group: "inventory", labelKey: "nav_groupInventory", Icon: Package, tint: "bg-amber-50 text-amber-600" },
  { group: "merchandising", labelKey: "nav_groupMerchandising", Icon: Tag, tint: "bg-purple-50 text-purple-600" },
  { group: "warehouse", labelKey: "nav_groupWarehouse", Icon: Factory, tint: "bg-slate-100 text-slate-600" },
  { group: "reports", labelKey: "nav_groupReports", Icon: BarChart3, tint: "bg-green-50 text-green-600" },
  { group: "ai-agent", labelKey: "nav_groupAiAgent", Icon: Bot, tint: "bg-indigo-50 text-indigo-600" },
  { group: "profile", labelKey: "nav_groupProfile", Icon: User, tint: "bg-slate-100 text-slate-600" },
];
  ...
  return (
    <div className="pt-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {tiles.map(({ group, labelKey, Icon, tint, pages }) => (
          <button
            key={group}
          ...
          >
            ...
            <div className="font-medium">{t(labelKey as any)}</div>
