...
export const translations = {
  my: {
    ...
    home_sendReport: "အစီရင်ခံစာ ပို့ရန်",
    home_subtitle: "ဘယ်အပိုင်းကို သွားမလဲ ရွေးပါ",
    home_pages: "စာမျက်နှာ",
    ...
    admin_noDepartment: "ဌာန မသတ်မှတ်ရသေး",
    ...
    admin_dept_office_support: "ရုံးပိုင်း",
    admin_dept_office: "ရုံးပိုင်း",
    admin_dept_management: "စီမံခန့်ခွဲရေး",
    admin_dept_system: "System",
    ...
    admin_role_hr_manager: "HR မန်နေဂျာ",
    admin_role_it_staff: "IT ဝန်ထမ်း",
    admin_role_marketing_executive: "စျေးကွက် အမှုဆောင်",
    admin_role_marketing_assistant: "စျေးကွက် လက်ထောက်",
    admin_role_content_writer: "Content ရေးသားသူ",
    admin_role_talent: "Talent",
    ...
    dept_onlineOrder: "အွန်လိုင်း",
    dept_finance: "ငွေစာရင်း",
    dept_dailyReport: "နေ့စဉ်အစီရင်ခံစာ",
    profile_changePw: "စကားဝှက် ပြောင်းရန်",
    profile_currentPw: "လက်ရှိ စကားဝှက်",
    profile_newPw: "စကားဝှက် အသစ်",
    profile_confirmPw: "စကားဝှက် အသစ် ထပ်ရိုက်ပါ",
    profile_pwTooShort: "စကားဝှက်သည် အနည်းဆုံး 8 လုံး ရှိရမည်",
    profile_pwMismatch: "စကားဝှက် နှစ်ခု မတူပါ",
    profile_pwWrongCurrent: "လက်ရှိ စကားဝှက် မှားနေပါသည်",
    profile_pwChanged: "စကားဝှက် ပြောင်းပြီးပါပြီ",
    profile_pwSaving: "ပြောင်းနေသည်...",
    admin_resetPw: "စကားဝှက် ပြန်ချိန်း",
    admin_resetPwPrompt: "စကားဝှက် အသစ် ရိုက်ထည့်ပါ",
    admin_pwTooShort: "စကားဝှက်သည် အနည်းဆုံး 8 လုံး ရှိရမည်",
    admin_pwReset: "စကားဝှက် ပြောင်းပြီးပါပြီ။ ဝန်ထမ်းကို အသိပေးပါ",
    ...
    lookup_posResults: "ဆိုင်မှာ ရောင်းထားသော",
    lookup_onlineResults: "အွန်လိုင်း အော်ဒါများ",
    lookup_onlineHint: "Messenger CRM ကနေ လာသော အော်ဒါများ — ဒီမှာ ကြည့်ရုံသာ",
    lookup_detail: "အသေးစိတ်",
    lookup_phone: "ဖုန်း",
    lookup_delivery: "ပို့ဆောင်မှု",
    lookup_paid: "ပေးပြီး",
    lookup_balance: "ကျန်ငွေ",
    lookup_voucher: "စာရင်း နံပါတ်",
    lookup_saleType: "အမျိုးအစား",
    lookup_type_walk_in: "ဆိုင်ဝင်",
    lookup_type_wholesale: "လက်ကား",
    lookup_type_online_retail: "အွန်လိုင်း လက်လီ",
    lookup_type_online_wholesale: "အွန်လိုင်း လက်ကား",
    lookup_noOnline: "အွန်လိုင်း အော်ဒါ မတွေ့ပါ",
  },
  en: {
    ...
    home_greeting: "Hello",
    home_sendReport: "Send Report",
    home_subtitle: "Where would you like to go?",
    home_pages: "pages",
    ...
    admin_noDepartment: "No department",
    ...
    admin_dept_office_support: "Office Support",
    admin_dept_office: "Office",
    admin_dept_management: "Management",
    admin_dept_system: "System",
    ...
    admin_role_hr_manager: "HR Manager",
    admin_role_it_staff: "IT Staff",
    admin_role_marketing_executive: "Marketing Executive",
    admin_role_marketing_assistant: "Marketing Assistant",
    admin_role_content_writer: "Content Writer",
    admin_role_talent: "Talent",
    ...
    dept_onlineOrder: "Online",
    dept_finance: "Finance",
    dept_dailyReport: "Daily Report",
    profile_changePw: "Change password",
    profile_currentPw: "Current password",
    profile_newPw: "New password",
    profile_confirmPw: "Repeat new password",
    profile_pwTooShort: "Password must be at least 8 characters",
    profile_pwMismatch: "The two passwords do not match",
    profile_pwWrongCurrent: "Current password is wrong",
    profile_pwChanged: "Password changed",
    profile_pwSaving: "Saving...",
    admin_resetPw: "Reset password",
    admin_resetPwPrompt: "New password",
    admin_pwTooShort: "Password must be at least 8 characters",
    admin_pwReset: "Password changed. Tell the staff member",
    ...
    lookup_posResults: "Sold in store",
    lookup_onlineResults: "Online orders",
    lookup_onlineHint: "Orders from the Messenger CRM — view only here",
    lookup_detail: "Detail",
    lookup_phone: "Phone",
    lookup_delivery: "Delivery",
    lookup_paid: "Paid",
    lookup_balance: "Balance",
    lookup_voucher: "Finance voucher",
    lookup_saleType: "Type",
    lookup_type_walk_in: "Walk-in",
    lookup_type_wholesale: "Wholesale",
    lookup_type_online_retail: "Online retail",
    lookup_type_online_wholesale: "Online wholesale",
    lookup_noOnline: "No online orders found",
  },
} as const;
