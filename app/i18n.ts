...
export const translations = {
  my: {
    ...
    nav_groupSale: "အရောင်း",
    nav_groupInventory: "ကုန်ပစ္စည်း",
    nav_groupMerchandising: "ကုန်ပစ္စည်း စီမံခန့်ခွဲမှု",
    nav_groupWarehouse: "ဂိုဒေါင်",
    nav_groupReports: "အစီရင်ခံစာ",
    nav_groupAiAgent: "AI Agent",
    nav_groupProfile: "ကျွန်ုပ်",
    home_greeting: "မင်္ဂလာပါ",
    home_subtitle: "ဘယ်အပိုင်းကို သွားမလဲ ရွေးပါ",
    home_pages: "စာမျက်နှာ",
    nav_groupSale: "အရောင်း",
  ...
  en: {
    ...
    home_pages: "pages",
    nav_groupSale: "Sale",
    nav_groupInventory: "Inventory",
    nav_groupMerchandising: "Merchandising",
    nav_groupWarehouse: "Warehouse",
    nav_groupReports: "Reports",
    nav_groupAiAgent: "AI Agent",
    nav_groupProfile: "Profile",
    home_greeting: "Hello",
    home_subtitle: "Where would you like to go?",
    home_pages: "pages",
    nav_groupSale: "Sale",
