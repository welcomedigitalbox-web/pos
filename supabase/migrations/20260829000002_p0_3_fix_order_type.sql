-- P0-3 fix: sales.order_type is NOT NULL. checkout_sale passed NULL when the
-- caller omitted it, which failed every POS sale. Default to 'walk_in' for
-- till sales; sale-order pages pass their own value.
