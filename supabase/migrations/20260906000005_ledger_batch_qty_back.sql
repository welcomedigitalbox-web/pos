-- The per-batch balance is the point of the batch rows: without it a 300
-- delivery and a 500 delivery both read 800, and the expiry split they
-- exist to show means nothing.
...
returns table (
  ...
  batch_id        uuid,
  expiry_date     date,
  qty_in_batch    numeric,   -- units left in this delivery
